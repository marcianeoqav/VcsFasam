/*	Exercício 17 da lista de filas e pilhas para N2.
 * 
 * Faça um programa que cadastre em uma pilha vários números. A entrada deles será
 * finalizada com a digitação de um número menor ou igual a zero. Posteriormente, 
 * o programa deve gerar duas filas, a primeira com os números pares e a segunda
 * com os números ímpares. A saída do programa deve apresentar a pilha digitada e
