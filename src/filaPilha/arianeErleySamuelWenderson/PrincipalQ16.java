...
public class Principal {
	...
	public void esquolha(int[] ep) throws Exception {
		...
		System.out
				.println("Digite 1 - Cadastrar aluno, 2 - Cadastrar nota, 3 - Calcular media de um aluno, 4 - Listar nome de alunos sem nota, 5 - Excluir aluno, 6 - Excluir nota, 7 - Sair ");
		...
		while (escolha != 7) {
			...
			if (escolha == 2) {
				System.out
						.println("Digite o numero do aluno dono da nota que será cadastrada = ");
				...
				if (ncadastrado == true) {
					System.out
							.println("ERRO- Aluno não cadastrado! Escolha novamente a opçaõ de Cadastrar nota e informe o numero de um aluno já cadastrado");
				}
				System.out
						.println("Digite 1 - Cadastrar aluno, 2 - Cadastrar nota, 3 - Calcular media de um aluno, 4 - Listar nome de alunos sem nota, 5 - Excluir aluno, 6 - Excluir nota, 7 - Sair ");
				escolha = entrada.nextInt();
			...
			if (escolha == 3) {
				System.out
						.println("Digite o numero do aluno desejado parar gerar a media do mesmo = ");
				numeroMEdia = entrada.nextInt();
			...
			if (escolha == 5) {
				...
				if (excluido == true) {
					System.out
							.println("Aluno não pode ser excluido, já que o mesmo pussui notas! ");
				}
				System.out
						.println("Digite 1 - Cadastrar aluno, 2 - Cadastrar nota, 3 - Calcular media de um aluno, 4 - Listar nome de alunos sem nota, 5 - Excluir aluno, 6 - Excluir nota, 7 - Sair ");
				escolha = entrada.nextInt();
			...
			if (escolha != 1 && escolha != 2 && escolha != 3 && escolha != 4
				...
				System.out
						.println("ERRO- Escolha invalida, por favor faça uma nova escolha");
				System.out
						.println("Digite 1 - Cadastrar aluno, 2 - Cadastrar nota, 3 - Calcular media de um aluno, 4 - Listar nome de alunos sem nota, 5 - Excluir aluno, 6 - Excluir nota, 7 - Sair ");
				escolha = entrada.nextInt();
			}
