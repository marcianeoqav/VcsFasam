 ...
 * 		* O m�todo main instancia os vetores e invoca os outros m�todos.
 */
...
public class Ex04 {
	public static int qt = Integer.parseInt(JOptionPane
			.showInputDialog("Quantas pessoas deseja registrar?"));
	public static String nomes[] = new String[qt];
	public static String prof[] = new String[qt];
	public static int idade[] = new int[qt];
	...
	public void preencheNome(String nomes[]) {
		nomes[contador] = JOptionPane
				.showInputDialog("Digite o nome da pessoa. Registro: "
						+ (contador + 1));
	}

	public void preencheProf(String prof[]) {
		prof[contador] = JOptionPane
				.showInputDialog("Digite a profiss�o da pessoa. Registro: "
						+ (contador + 1));
	}

	public void preencheIdade(int idade[]) {
		idade[contador] = Integer.parseInt(JOptionPane
				.showInputDialog("Digite a idade da pessoa. Registro: "
						+ (contador + 1)));
	}
