/*
8 Implementar na linguagem de programação Java, uma classe que leia uma matriz de inteiros
    de dimensões 10 x 10 e imprima os elementos da diagonal principal desta matriz;
8.1 A implementação deverá conter apenas uma classe java com os seguintes métodos:
8.2 Um método para o preenchimento dos dados da matriz. Este método recebe a
    matriz como parâmetro, mas não retorna nada;
8.3 Um método para a impressão de todos elementos acima da diagonal secundária.
    Este método recebe a matriz como parâmetro, mas não retorna nada;
8.4 Um método main, para coordenar os trabalhos da classe, chamando os serviços
...
public class Exerc08 {
    ...
    System.out.print("\n\n");
       ...
       public static void main(String args[]){
        ...
        Exerc08 Obj = new Exerc08();//instacia os objetos dentro da classe principal
