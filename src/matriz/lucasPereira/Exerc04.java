/*4 Implementar na linguagem de programação Java, uma classe que leia uma matriz de inteiros
    de dimensões 10 x 10 e imprima os elementos da diagonal principal desta matriz;
    4.1 A implementação deverá conter apenas uma classe java com os seguintes métodos:
    4.2 Um método para o preenchimento dos dados da matriz. 
        *Este método recebe a matriz como parâmetro, mas não retorna nada;
        *Um método para a impressão de todos elementos acima da diagonal principal.
        *Este método recebe a matriz como parâmetro, mas não retorna nada;
    4.4 Um método main, para coordenar os trabalhos da classe, chamando os serviços disponibilizados pelos dois métodos descritos anteriormente;
*/
...
public class Exerc04 {
    ...
    public static void imprimeMatrizDiagonalSuperior(int[][] mat){
      ...
      public static void main(String args[]){
        ...
        Exerc04 Obj = new Exerc04();//instacia os objetos dentro da classe principal
        ...
        imprimeMatrizDiagonalSuperior(Obj.matriz);//imprime os elementos da matriz diagonal inferior
