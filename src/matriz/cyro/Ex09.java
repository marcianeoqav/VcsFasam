/*	Exerc�cio 9 da lista de Matrizes para N2.
...
public class Ex09 
{
	...
	{
		Ex09 objeto = new Ex09();		// Instancia um objeto da classe Ex_7
	...
	public static void imprimeDiagSecInf(int[][] m)	// M�todo de impress�o. Recebe a matriz do objeto como par�metro. 
	{		
		...
		for (int a = 0; a < m.length; a++)		// Repete pelo n�mero de linhas (a) ...
		{
			for (int b = 0; b < m[0].length; b++)	// ...e colunas (b) da matriz.
			{
				//	Repetindo o truque: Os elementos que est�o ABAIXO da diagonal secund�ria
				//  t�m o �ndice da coluna MAIOR que ((tamanho do vetor) - (�ndice da linha) - 1). 
				
				if (b > (m.length - a) - 1)	//  Se o elemento estiver ABAIXO da diagonal secund�ria...
				{							 
					System.out.print(m[a][b] + "\t");	// ...imprime o elemento! 
				}
				else	// Se o elemento N�O estiver abaixo da diagonal secund�ria...
				{
					System.out.print("  \t"); // ...imprime dois espa�os e um caractere de tabula��o,
				}							  // ...para formatar a matriz corretamente.
			}
			System.out.print("\n"); // Separador de linhas dentro da matriz
		}
		System.out.print("\n\n"); // Separador de linhas entre as matrizes
	} // Fim do m�todo de impress�o dos elementos ABAIXO da diagonal secund�ria.
