...
public class Questao06 {
	...
	de dimens�es 10 x 10 e imprima os elementos da diagonal principal desta matriz;
	 6.1  A  implementa��o   dever�   conter  apenas   uma  classe  java   com  os   seguintes 
	m�todos:
	 6.2  Um m�todo para o preenchimento dos dados da matriz. Este m�todo recebe a 
	matriz como par�metro, mas n�o retorna nada;
	 6.3  Um m�todo para a impress�o dos elementos da diagonal secund�ria. Este m�todo 
	recebe a matriz como par�metro, mas n�o retorna nada;
	 6.4  Um m�todo main, para coordenar os trabalhos da classe, chamando os servi�os 
	...
	//M�todo que vai realizar a impress�o dos elementos da diagonal secund�ria.
		//6.3
		private static void exibirDiagonalSecundariaMatriz(int matAux [][], int maxI, int maxJ){
			int i,j;
			System.out.printf("\n");
			System.out.printf("Elementos da diagonal secund�ria s�o: \n");
			for (i=0; i<maxI; i++){
				for (j = 0; j < maxJ; j++) {
					if ((i+j)==2){//soma dos i+j ==maxI -1
	...
	//6.4 - M�todo main
		public static void main (String args[]){
			...
			Questao06.preencherMatriz(matriz,dI,dJ);
					
			Questao06.exibirDiagonalSecundariaMatriz(matriz,dI,dJ);
		}
}
