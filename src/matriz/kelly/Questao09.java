...
de dimens�es 10 x 10 e imprima os elementos da diagonal principal desta matriz;
 9.1  A  implementa��o   dever�   conter  apenas   uma  classe  java   com  os   seguintes 
m�todos:
 9.2  Um m�todo para o preenchimento dos dados da matriz. Este m�todo recebe a 
matriz como par�metro, mas n�o retorna nada;
 9.3  Um m�todo para a impress�o de todos elementos abaixo da diagonal secund�ria. 
Este m�todo recebe a matriz como par�metro, mas n�o retorna nada;
 9.4  Um m�todo main, para coordenar os trabalhos da classe, chamando os servi�os 
disponibilizados pelos dois m�todos descritos anteriormente;*/
	...
	// matAux(Matriz a ser preenchida) maxI(Valor max de coluna) maxJ(Valor max de linha)
		...
		// M�todo que vai realizar a impress�o dos elementos da matriz abaixo da diagonal secund�ria.
		// 8.3
		private static void exibirAbaixoDaDiagonalSecundariaMatriz(int matAux[][],int maxI, int maxJ) {
			int i, j;
			System.out.printf("\n");
			System.out.printf("Elementos da matriz abaixo da diagonal secund�ria s�o: \n");
			for (i = 0; i < maxI; i++) {
				for (j = 0; j < maxJ; j++) {
		...
		public static void main(String args[]) {
			...
			Questao09.preencherMatriz(matriz, dI, dJ);

			Questao09.exibirAbaixoDaDiagonalSecundariaMatriz(matriz, dI, dJ);
		}
}
