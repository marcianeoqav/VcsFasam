...
public class Exercicio09 {
	...
	public static void main(String[] args) {
		Preencher(Matriz);
		BaixoDiagonalSec(Matriz, Matrizaux);
	...
	public static void BaixoDiagonalSec(int Matriz[][], int Matrizaux[][]){
		for(int i = 0; i < 10; i++){
			for(int j = 0; j < 10; j++){
				if(i + j >= 10)  
	...
	public static void Imprimi(int Matriz[][], int Matrizaux[][]){
		...
		System.out.println("\n");
		System.out.println("Elementos abaixo da Diagonal Secundaria:");
		for(int i = 0; i < 10; i++){
			System.out.println("\n");
			for(int j = 0; j < 10; j++){
